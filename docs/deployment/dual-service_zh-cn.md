# 双服务部署 - FastMCP + HTTP 仪表盘

[简体中文](dual-service_zh-cn.md) | [English](dual-service.md)

## 概览

本部署同时提供 **FastMCP 协议** 与 **HTTP 仪表盘**，绕开 Node.js SSL 问题并保持完整功能。
